...
export default mergeIds(workbenchId, workbench, {
  string: {
    ...
    SupportNoticeTitle: '' as IntlString,
    SupportNoticeBody: '' as IntlString,
    SupportNoticeCardDescription: '' as IntlString,
    SupportNoticeUnderstood: '' as IntlString,
    SupportNoticeOpen: '' as IntlString,
