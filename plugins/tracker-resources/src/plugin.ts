...
export default mergeIds(trackerId, tracker, {
  ...
  string: {
    ...
    PdcaCycleDaily: '' as IntlString,
    PdcaCycleWeekly: '' as IntlString,
    PdcaCycleBiweekly: '' as IntlString,
    PdcaCycleMonthly: '' as IntlString,
    PdcaCycleQuarterly: '' as IntlString,
    PdcaCycleCustom: '' as IntlString,
    PdcaCustomWeekdays: '' as IntlString,
    ...
    AutomationScriptName: '' as IntlString,
    AutomationScriptDescriptionField: '' as IntlString,
    AutomationVariants: '' as IntlString,
    AddVariantOption: '' as IntlString,
    VariantOptionPlaceholder: '' as IntlString,
    AutomationScriptSteps: '' as IntlString,
    AddScriptStep: '' as IntlString,
    ScriptStepTemplate: '' as IntlString,
    RequireAll: '' as IntlString,
    RequireNone: '' as IntlString,
    RequireAllHint: '' as IntlString,
    RequireNoneHint: '' as IntlString,
    CustomScripts: '' as IntlString,
    NoCustomScripts: '' as IntlString,
    NewScript: '' as IntlString,
    EditScript: '' as IntlString,
    DeleteScript: '' as IntlString,
    RunScript: '' as IntlString,
    SaveScript: '' as IntlString,
    ConfirmDeleteScript: '' as IntlString,
    ScriptStepsCount: '' as IntlString,
    SelectVariantOptions: '' as IntlString,
    NoStepsConfigured: '' as IntlString,
    NoStepsForVariants: '' as IntlString,
    StepsThatWillRun: '' as IntlString,
    RunAutomationScript: '' as IntlString,
    ScriptExecutedAt: '' as IntlString,
    LegacyOnboardingSection: '' as IntlString,
    AddProjectGroup: '' as IntlString,
    AddTemplateToProject: '' as IntlString,
    RemoveProjectGroup: '' as IntlString,
    TemplatesInProjectCount: '' as IntlString,
    SelectProjectPlaceholder: '' as IntlString,
    SelectTemplatePlaceholder: '' as IntlString,
    ConfirmRemoveProjectGroup: '' as IntlString,
    AssigneeByLabel: '' as IntlString,
    AssigneeByLabelHint: '' as IntlString,
    NoLabelsInScript: '' as IntlString,
    LabelNoAssignee: '' as IntlString,
    MultipleLabelsWarning: '' as IntlString,
    MultipleLabelsTooltip: '' as IntlString,
  ...
  component: {
    ...
    StatusEditor: 'tracker.component.StatusEditor' as AnyComponent,
    IssueColumnHeader: 'tracker.component.IssueColumnHeader' as AnyComponent,
    Kanban: 'tracker.viewlet.Kanban' as AnyComponent,
