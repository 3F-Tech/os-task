...
|---|---|---|---|
| F01 | Validação de Conclusão de Issue | `feature/issue-completion-validation` | ✅ Mergeado |
| F02 | Compartilhamento por Tags | `feature/tag-based-sharing` | ✅ Mergeado |
| F03 | Datas Automáticas (start + finalização) | `feature/automatic-dates` | 🔲 A desenvolver |
| F04 | Ciclo PDCA | `feature/pdca-cycle` | 🔲 A desenvolver |
